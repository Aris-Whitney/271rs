...
cargo build -p sha512_42 --release
...
diff <(sha512sum 15char.txt) <(./target/release/sha512_42 15char.txt)
diff <(sha512sum lipsum.txt) <(./target/release/sha512_42 lipsum.txt)
diff <(sha512sum austen.txt) <(./target/release/sha512_42 austen.txt)
